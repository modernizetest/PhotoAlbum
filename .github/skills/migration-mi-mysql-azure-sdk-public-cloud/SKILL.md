---
name: migration-mi-mysql-azure-sdk-public-cloud
...
Your job is to migrate from MySQL to Azure Database for MySQL with Azure SDK and managed identity for secure, credential-free authentication.
...
* KB ID: 
* Title: Upgrade code to use Managed Identity in Azure MySQL (Public Cloud)
* Description: Migrate Azure MySQL authentication to a managed identity using AzureMysqlAuthenticationPlugin.
* Content: 

## Upgrade code to use Managed Identity in Azure MySQL (Public Cloud)

Migrate Azure MySQL authentication to a managed identity using AzureMysqlAuthenticationPlugin.
...
Your task is to migrate a java file from using a connection string to using passwordless managed identity for authentication in Azure MySQL (Public Cloud).
...
## Add dependency for Managed Identity in Azure MySQL (Public Cloud)
...
- Regex pattern to find code lines: `mysql`
...
Note:  Please check the latest version of the dependency, and update the version if possible.



## Add properties for Managed Identity in Azure MySQL (Public Cloud)
...
Your task is to migrate a configuration file to use managed identity for authentication in Azure MySQL instead of a password.
...
2. Remove the configuration for the password of the **MySQL** database:
