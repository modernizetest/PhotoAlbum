...
4. **Generate resources-summary.md** after successful provisioning following the template in [../resources-template.md](../resources-template.md). This file is critical for downstream tasks (deployment, integration tests) to discover provisioned resources. Key requirements:
