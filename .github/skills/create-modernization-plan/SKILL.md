...
3. **Generate plan and tasks**: Generate plan.md and tasks.json using the appropriate templates:
    ...
    **.NET Upgrade Task Guidelines**: Only add an upgrade task if the user explicitly requests it. You must refer to the ./dotnet-upgrade-guideline.md for specific rules and guidelines when creating .NET upgrade tasks.
