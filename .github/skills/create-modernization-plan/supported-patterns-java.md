...
- **migration-mi-cassandra-azure-sdk-public-cloud**: Update Java projects to connect to Azure Cosmos DB for Cassandra using managed identity in Azure public cloud.
