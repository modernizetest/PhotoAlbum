...
- **migration-cryptography-operations-to-azure-key-vault**: Migrate cryptography operations to Azure Key Vault
...
- **migration-mi-azure-sql**: Secure Azure SQL Database with Managed Identity
...
- **migration-mi-cassandra-azure-sdk-public-cloud**: Via Azure SDK for public cloud
- **migration-mi-eventhub-spring**: Azure Event Hubs Managed Identity via Spring
...
- **migration-mi-mysql**: Secure Azure Database for MySQL with Managed Identity
...
- **migration-mi-postgresql**: Secure Azure Database for PostgreSQL with Managed Identity
