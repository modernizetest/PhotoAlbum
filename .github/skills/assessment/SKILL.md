...
- **For Java**: Generates report at `{workspace-path}/.github/appmod/appcat/result/report.json`
- **For .NET**: Generates report at `{workspace-path}/.github/modernize/assessment/report.json`
