---
name: azcli-functionapp-deploy
description: Deployment steps for Azure Function App under the AzCLI flow
---

# AzCLI Function App Deployment

This skill provides deployment guidance for Azure Function App under the AzCLI flow. It is designed to be called when Azure Function App is identified as the target compute host for a service.
  ...
  **Below are the steps for Copilot to follow; ask Copilot to update or execute this plan. Add check list for the steps.** 
  Execution Steps:
    ...
    3. Check Azure resources existence:
      1. Azure Functions for app fakeservice0:
        - name: <>, resource group: <>, subscription: <>, provisioningState: Succeeded, runningStatus: Running. Check with 'az functionapp show -o json'
