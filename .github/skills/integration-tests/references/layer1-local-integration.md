...
- !! Service Bus Emulator does not support JMS, so the JMS related tests cannot use the emulator to test.
...
> **Note:** Service Bus and Event Hubs emulators require companion containers and a JSON config file. See [azure-servicebus-testcontainers.md](./azure-servicebus-testcontainers.md) and [azure-eventhubs-testcontainers.md](./azure-eventhubs-testcontainers.md)for the config format.
