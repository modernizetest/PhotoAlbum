...
> **Note:** Service Bus and Event Hubs emulators require companion containers and a JSON config file. See [servicebus-testcontainers-java.md](./servicebus-testcontainers-java.md) for the config format.
