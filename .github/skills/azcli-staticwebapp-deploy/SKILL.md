...
This skill provides deployment guidance for Azure Static Web Apps under the AzCLI flow, using some existing Azure resources. It is designed to be called when Azure Static Web Apps is identified as the target compute host for a service.
