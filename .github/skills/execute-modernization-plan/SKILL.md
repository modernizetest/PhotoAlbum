...
8. **Playbook Evidence Validation** (only when playbook attachments are present):
   After final verification, call skill `validate-playbook-evidence` to analyze code changes and produce playbook compliance evidence:
