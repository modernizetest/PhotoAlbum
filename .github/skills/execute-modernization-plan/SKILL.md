...
8. Output of plan execution:
   ...
   - Make sure the tasks.json is updated with the final status of each task (success, failed, or skipped) and include a summary of the changes made in each task in the modernization-summary.md file within the modernization-work-folder for each task.
