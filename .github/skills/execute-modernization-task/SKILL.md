...
If `./infra/resources-summary.md` exists, it contains information about Azure resources provisioned by an infrastructure task. This information can help you use correct resource names and endpoints in configuration templates.
